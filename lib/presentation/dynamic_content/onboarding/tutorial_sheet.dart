  ...
  Widget build(BuildContext context) {
    final List<Widget> tutorialPages = [
      _pageContents(
        context: context,
        title: LabelsManager()
            .getRemoteStringFromLabelKeys(RemoteLabelKeys.for_you),
        text: LabelsManager()
            .getRemoteStringFromLabelKeys(RemoteLabelKeys.for_you_tutorial),
      ...
      _pageContents(
        ...
        text: LabelsManager()
            .getRemoteStringFromLabelKeys(RemoteLabelKeys.profile_tutorial),
      ...
      _pageContents(
        context: context,
        title: LabelsManager()
            .getRemoteStringFromLabelKeys(RemoteLabelKeys.explore),
        text: LabelsManager()
            .getRemoteStringFromLabelKeys(RemoteLabelKeys.explore_tutorial),
      ...
      _pageContents(
        context: context,
        title: LabelsManager()
            .getRemoteStringFromLabelKeys(RemoteLabelKeys.community),
        text: LabelsManager()
            .getRemoteStringFromLabelKeys(RemoteLabelKeys.community_tutorial),
                    ...
                    child: Row(
                      children: [
                        ...
                        StyledIconButton(
                          ...
                          onTap: () {
                            final skip =
                                form.findControl('showAgain')?.value as bool?;
                            context
                                .read<OnboardingSheetCubit>()
                                .setSkipTutorial(skip ?? false);
            ...
            children: [
              ...
              Text(
                ...
                style: AppTextTheme.title(
                    size: 20.0, color: ColorManager().getColorTextPrimary()),
              )
            ],
          ),
