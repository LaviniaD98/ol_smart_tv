...
import '../dynamic_content/strip/community/comments/widgets/empty_comments.dart';
import '../dynamic_content/strip/community/post/post_page.dart';
import '../wall/widgets/on_scroll_error.dart';

class CourseDetailOpinions extends StatelessWidget {
  final DetailPageModel model;
  final DetailPageArgs args;

  const CourseDetailOpinions({
    super.key,
    required this.model,
    required this.args,
  });
  ...
  Widget build(BuildContext context) {
    ...
    return RefreshIndicator(
      ...
      onRefresh: () => context.read<DetailPageCubit>().init(args),
        ...
        slivers: <Widget>[
          PagedSliverList(
            ...
            builderDelegate: PagedChildBuilderDelegate<CommunityDataModel>(
              ...
              itemBuilder: (context, item, index) => _card(context, item),
