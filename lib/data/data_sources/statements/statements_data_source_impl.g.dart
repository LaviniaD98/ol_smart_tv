...
part of 'statements_data_source_impl.dart';
...
class _StatementsDataSourceImpl implements StatementsDataSourceImpl {
  ...
  Future<List<String>> statements(
    String xapiVer,
    String path,
    StatementsDto statObj,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'X-Experience-Api-Version': xapiVer};
    _headers.removeWhere((k, v) => v == null);
    final _data = <String, dynamic>{};
    _data.addAll(statObj.toJson());
    final _result =
  ...
  Future<XapiStateResultsDto> setState(
    ...
    _headers.removeWhere((k, v) => v == null);
    final _data = <String, dynamic>{};
    _data.addAll(stateDto.toJson());
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<XapiStateResultsDto>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
