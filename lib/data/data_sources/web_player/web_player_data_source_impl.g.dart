...
part of 'web_player_data_source_impl.dart';
...
class _WebPlayerDataSourceImpl implements WebPlayerDataSourceImpl {
  ...
  Future<SessionIdResponseDto> requestSessionId(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<SessionIdResponseDto>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<LinkedinResponseDto> requestLinkedinUrl(
    ...
    _data.addAll(param.toJson());
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<LinkedinResponseDto>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
