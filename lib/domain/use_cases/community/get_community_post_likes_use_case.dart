...
@lazySingleton
class GetCommunityPostLikesUseCase {
  final CommunityRepository _repository;
  final GetSecureStoredUserInfoUseCase _getSecureStoredUserInfoUseCase;

  GetCommunityPostLikesUseCase(
      this._repository,
      this._getSecureStoredUserInfoUseCase
      );

  Future<Either<Failure, CommunityPostsModel>> call(int entityId, String? apiPath) async {
    /// Get initiativeId
    ...
    return await _repository.getPostLikes(
      entityId: entityId,
