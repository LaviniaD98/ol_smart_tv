...
@lazySingleton
class GetRelatedActivitiesUseCase {
  ...
  GetRelatedActivitiesUseCase(
    this._repository,
    this._getSecureStoredUserInfoUseCase,
    this._getStoredCorporateIdUseCase,
  );

  Future<Either<Failure, ReleatedLearningActivityResponseModel>> call(
      String id) async {
    /// Get initiativeId
    ...
    final String path =
        "/learning-catalogue/{corporateId}/{initiativeId}/learningObjects/{learningObjectId}/relatedLearningActivities?pageNumber=0&pageSize=9"
    ...
    return await _repository.getRelatedActivities(path);
  }
}
